...
const FirebaseSVG = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <use xlinkHref="#a" fill={colors.marquee} fillRule="evenodd" />
    ...
    />
    <use xlinkHref="#c" fill={colors.marquee} fillRule="evenodd" />
