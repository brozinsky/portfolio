...
const arrowIcon = <FontAwesomeIcon className="arrow-top" icon={faChevronUp} />;
const githubIcon = (
  ...
  return (
    <>
      <StyledFooter className="footer mt-section">
        <TriangleBackground />
        <ButtonCenter>
          <ButtonToTop onClick={handleScrollButton}>{arrowIcon}</ButtonToTop>
        </ButtonCenter>
        <WrapLinks>
          <a href="https://github.com/brozinsky" target="_blank" aria-label="Github">
            {githubIcon}
          </a>
          <a
        ...
        <Small>
          Created by &nbsp;
          <SmallLink href="https://github.com/brozinsky">brozinsky</SmallLink>
          &copy; 2021
        </Small>
      </StyledFooter>
    </>
